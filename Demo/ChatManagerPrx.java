...
{
    default void subscribe(CallbackReceiverPrx callback, String hostname)
    {
        subscribe(callback, hostname, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void subscribe(CallbackReceiverPrx callback, String hostname, java.util.Map<String, String> context)
    {
        _iceI_subscribeAsync(callback, hostname, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> subscribeAsync(CallbackReceiverPrx callback, String hostname)
    {
        return _iceI_subscribeAsync(callback, hostname, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> subscribeAsync(CallbackReceiverPrx callback, String hostname, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_subscribeAsync(CallbackReceiverPrx iceP_callback, String iceP_hostname, java.util.Map<String, String> context, boolean sync)
    {
